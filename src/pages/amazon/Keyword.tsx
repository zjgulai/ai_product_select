...
export default function AmazonKeyword() {
  ...
  return (
    <div className="animate-fadeIn">
      ...
      {/* Search Section */}
      <div className="bg-white rounded-lg shadow-lc p-6 mb-4 ring-1 ring-lc-border/60 text-center">
          ...
          {statsLoading ? (
            ...
            stats?.map((stat) => (
              <div key={stat.title}
                ...
                className="bg-white rounded-lg shadow-lc p-4 transition-all duration-200 hover:-translate-y-1 hover:shadow-lc-hover cursor-pointer group ring-1 ring-lc-border/40 relative overflow-hidden">
